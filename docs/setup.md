...
> **PC Gazebo 시뮬**: [simulation-setup.md](./simulation-setup.md) ★  
> **보드 주행**: [board-workflow.md](./board-workflow.md) ★
...
| `src/` 링크 | camera, control, joystick 등 공식 패키지 + `limo_car` → `vendor/limo_car` |
| `config/` | `vehicle_config.yaml` → `src/config/` (팀 카메라 320×180) |
